...
void _run_feedforward_post_push_spikes()
{
	...
	feedforward_post.advance();
	feedforward_post.push(_ptr_array_layer23__spikespace, _ptr_array_layer23__spikespace[_num_spikespace-1]);
	//feedforward_post.queue->peek();
}
