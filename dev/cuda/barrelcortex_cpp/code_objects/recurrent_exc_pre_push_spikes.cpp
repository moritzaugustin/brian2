...
void _run_recurrent_exc_pre_push_spikes()
{
	...
	recurrent_exc_pre.advance();
	recurrent_exc_pre.push(_ptr_array_layer23__spikespace, _ptr_array_layer23__spikespace[_num_spikespace-1]);
	//recurrent_exc_pre.queue->peek();
}
