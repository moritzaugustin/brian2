...
void _run_feedforward_post_codeobject()
{	
...
const int _numA_target = _dynamic_array_feedforward_A_target.size();
 ...
 double * __restrict _ptr_array_feedforward_A_target = _array_feedforward_A_target;
	...
	std::vector<int> *_spiking_synapses = feedforward_post.peek();
   ...
   A_target += (-0.0002990697562442441);
   w = _clip(w + A_source, 0, 0.007476743906106103);
   lastupdate = t;
...
void _debugmsg_feedforward_post_codeobject()
{
	using namespace brian;
