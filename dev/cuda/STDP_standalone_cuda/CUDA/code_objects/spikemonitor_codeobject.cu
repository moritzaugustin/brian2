...
__global__ void _run_spikemonitor_codeobject_kernel(int stride, double par_clock_t, int32_t* par_array_poissongroup__spikespace)
{
...
void _run_spikemonitor_codeobject()
{
	...
	_run_spikemonitor_codeobject_kernel<<<num_blocks_sequential,1>>>(1024/num_blocks_sequential, _clock_t, dev_array_poissongroup__spikespace);
}
