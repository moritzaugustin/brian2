...
__global__ void _run_poissongroup_group_variable_set_conditional_codeobject_kernel(int par_numrates,
...
void _run_poissongroup_group_variable_set_conditional_codeobject()
{
	...
	_run_poissongroup_group_variable_set_conditional_codeobject_kernel<<<1,N>>>(_numrates,
		dev_array_poissongroup_rates);
}
