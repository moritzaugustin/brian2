...
__global__ void _run_neurongroup_resetter_codeobject_kernel(int par_num_spikespace, int par_numv, int32_t* par_array_neurongroup__spikespace, double* par_array_neurongroup_v)
{
	int tid = threadIdx.x;
...
void _run_neurongroup_resetter_codeobject()
{
	...
	//// MAIN CODE ////////////
	_run_neurongroup_resetter_codeobject_kernel<<<1, N>>>(_num_spikespace, _numv, dev_array_neurongroup__spikespace, dev_array_neurongroup_v);
}
