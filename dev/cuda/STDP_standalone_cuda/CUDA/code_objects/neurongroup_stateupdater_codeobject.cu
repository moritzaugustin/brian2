...
__global__ void _run_neurongroup_stateupdater_codeobject_kernel(int par_numge, int par_numv,
	double par_dt, double* par_array_neurongroup_ge, double* par_array_neurongroup_v)
{
	int tid = threadIdx.x;
...
void _run_neurongroup_stateupdater_codeobject()
{
	...
	_run_neurongroup_stateupdater_codeobject_kernel<<<1,N>>>(_numge, _numv, dt,
		dev_array_neurongroup_ge, dev_array_neurongroup_v);
}
