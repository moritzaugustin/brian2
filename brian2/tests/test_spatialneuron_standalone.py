...
def test_infinitecable():
    ...
    run(0.02*ms, report='text')
    neuron.I=0*amp
    run(3*ms, report='text')
    
    device.build(directory='test_infinitecable_'+device_name, compile=True,
                run=True, debug=True)  
...
def test_finitecable():
    ...
    device.build(directory='test_finitecable_'+device_name, compile=True,
                run=True, debug=True)
...
def test_rallpack1():
    ...
    device.build(directory='test_rallpack1_'+device_name, compile=True,
                run=True, debug=True)
...
def test_rallpack2():
    ...
    run(250*ms + defaultclock.dt, report='text')
    device.build(directory='test_rallpack2_'+device_name, compile=True,
                run=True, debug=True)
...
def test_rallpack3():
    ...
    run(250*ms + defaultclock.dt, report='text')
    device.build(directory='test_rallpack3_'+device_name, compile=True,
                run=True, debug=True)
...
def test_rall():
    ...
    device.build(directory='test_rall_'+device_name, compile=True,
                run=True, debug=True)
...
#    print('running test_construction()')
#    test_construction()

#    print('running test_construction_coordinates()')
#    test_construction_coordinates()
    
#    print('running test_infinitecable()')
#    test_infinitecable()

#    print('running test_finitecable()')
#    test_finitecable()
#
#    print('running test_rallpack1()')
#    test_rallpack1()

    print('running test_rallpack2()')
    test_rallpack2()

#    print('running test_rallpack3()')
#    test_rallpack3()
#
#    print('running test_rall()')
#    test_rall()
